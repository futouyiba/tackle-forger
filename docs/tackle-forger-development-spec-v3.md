...
| OPEN-009 工作流治理策略 | 产品/安全决策 | `RESOLVED` | 使用`open009-2026-07-23-v1`四类策略；所有已登录公司用户拥有全部已启用Capability；AI一期禁用且仍受OPEN-006阻断 | 不接飞书审批、不在本工具实行职责分离；关键写操作使用工作区单写锁，普通操作记录保留1年 | 2026-07-23用户确认；策略正文见第20.2节，迁移与验收见Issue #18 |
