...
test("action-command 路由保留坏行重量草稿，并在发布路由明确阻断", { concurrency: false }, async () => {
  ...
  const weightTemplateDraft = weightTemplateDraftFromCanonicalRuleDraft({ sourceRevision, canonicalRuleDraft, weightSources: [], importedAt: sourceRevision.pulledAt });
  setCanonicalRuleWorkbookInspectionForTests(async () => ({ observedAt: sourceRevision.pulledAt, sourceRevision, identityRows: [], identityReport: { reportId: "identity-route-bad-weight", workbookRefId: sourceRevision.workbookRefId, sourceRevision: sourceRevision.sourceRevision, mode: "CONTINUOUS_SYNC", generatedAt: sourceRevision.pulledAt, items: [], blockingIssueCodes: [], inputHash: "identity" }, canonicalRuleDraft, weightTemplateDraft, qualityDraft: { id: "quality-route", sourceRevisionId: sourceRevision.id, sourceRevision: sourceRevision.sourceRevision, qualitySheetId: "27hboC", affixSheetId: "23CsXE", ranges: [], combinationRules: [], issues: [], formalStatus: "NON_FORMAL", inputHash: "quality", importedAt: sourceRevision.pulledAt }, pricingDraft: { id: "pricing-route", sourceRevisionId: sourceRevision.id, sourceRevision: sourceRevision.sourceRevision, pricingSheetId: "31RxeB", qualitySheetId: "27hboC", typeMaterialSheetId: "10TyFp", maintenanceConsumptionRates: [], partAllocationRatios: [], repairCoefficients: [], totalLossTimes: [], purchaseCoefficients: [], partsToWholeRatios: [], qualityMappings: [], qualityPriceFactorRanges: [], issues: [], formalStatus: "NON_FORMAL", inputHash: "pricing", importedAt: sourceRevision.pulledAt }, pricingWeightBandPolicy: "MATCHED_STRUCTURAL_SOURCE_BAND", seriesDefinitions: [], seriesParseIssues: [] } as never));
  try {
